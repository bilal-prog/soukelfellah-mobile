const en = {
  ...
  addListing: {
    ...
    addPhotoSourceTitle: "Add Photos",
    cameraOption: "Take Photo",
    galleryOption: "Choose from Gallery (Multi-select)",
    cancelOption: "Cancel",
    principalPhotoBadge: "Main Cover Photo",
    setAsPrincipal: "Set as Principal",
    moveLeft: "Move left",
    moveRight: "Move right",
    multiPhotoHint: "You can select multiple photos at once (up to 5)",
    ...
    communeLabel: "Commune (Optional)",
    selectCommunePlaceholder: "Select Commune",
    communeWarningTitle: "Warning",
    communeWarningMsg: "Please select a province first.",
    ...
    missingItemTitle: "Can't find your category, product type, or unit?",
    missingItemDesc: "Tell us what is missing and send your suggestion directly on WhatsApp.",
    missingTypeCategory: "Missing Category",
    missingTypeProduct: "Missing Product Type",
    missingTypeUnit: "Missing Unit of Measure",
    missingTypeOther: "Other Suggestion",
    missingInputPlaceholder: "Ex: 25kg Box, Articulated Tractor...",
    missingWhatsappBtn: "Suggest via WhatsApp",
  },
  editListing: {
    title: "Edit Listing",
