...
const fr: Translations = {
  ...
  addListing: {
    ...
    addPhotoSourceTitle: "Ajouter des photos",
    cameraOption: "Prendre une photo",
    galleryOption: "Choisir depuis la galerie (sélection multiple)",
    cancelOption: "Annuler",
    principalPhotoBadge: "Photo principale",
    setAsPrincipal: "Définir comme principale",
    moveLeft: "Déplacer à gauche",
    moveRight: "Déplacer à droite",
    multiPhotoHint: "Vous pouvez sélectionner plusieurs photos à la fois (jusqu'à 5)",
    ...
    communeLabel: "Commune (Optionnel)",
    selectCommunePlaceholder: "Choisir la Commune",
    communeWarningTitle: "Avertissement",
    communeWarningMsg: "Veuillez d'abord choisir une province.",
    ...
    missingItemTitle: "Vous ne trouvez pas votre catégorie ou unité ?",
    missingItemDesc: "Indiquez-nous l'élément manquant et contactez notre équipe sur WhatsApp.",
    missingTypeCategory: "Catégorie manquante",
    missingTypeProduct: "Type de produit manquant",
    missingTypeUnit: "Unité de mesure manquante",
    missingTypeOther: "Autre suggestion",
    missingInputPlaceholder: "Ex: Caisse de 25kg, Tracteur articulé...",
    missingWhatsappBtn: "Envoyer sur WhatsApp",
  },
  editListing: {
