...
export const ListingImageManager: FC<ListingImageManagerProps> = memo(
          ...
          {isUploading ? (
            ...
            <View style={$uploadContent}>
              ...
              <Text
                ...
                size="xxs"
                style={{ color: colors.palette.onSurfaceVariant, marginTop: vs(2), textAlign: "center" }}
              />
            </View>
          )}
        </TouchableOpacity>
                ...
                >
                  ...
                  {isPrincipal ? (
                    ...
                    >
                      ...
                      <Text
                        tx="addListing:setAsPrincipal"
                        size="xxs"
                        style={$setPrincipalText}
                      />
                    </TouchableOpacity>
                  )}
